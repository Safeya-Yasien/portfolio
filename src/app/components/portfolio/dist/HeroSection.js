        ...
        react_1["default"].createElement("div", { className: "container " },
            react_1["default"].createElement("div", { className: "grid grid-cols-1 lg:grid-cols-2 gap-6" },
                react_1["default"].createElement("div", { className: "" },
                    react_1["default"].createElement(image_1["default"], { src: "/hero.jpg", alt: "safeya yasien", height: 520, width: 520, className: "border rounded " })),
                react_1["default"].createElement("div", { className: "flex flex-col space-y-5 " },
