...
var ServicesSection = function () {
    return (react_1["default"].createElement("section", { id: "services" },
        react_1["default"].createElement("div", { className: "container" },
            ...
            react_1["default"].createElement("div", { className: "grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-5" }, servicesData_1.servicesData.map(function (service, index) { return (react_1["default"].createElement(ServiceCard_1["default"], { key: index, title: service.title, description: service.description })); })))));
};
